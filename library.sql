...
drop database if exists dxclibrary;

create database dxclibrary;
...
Insert into LibUsers values('Bhargav','Ravula');
Insert into LibUsers values('Sravani','Kondapally');
Insert into LibUsers values('Sateesh','Kumar');
Insert into LibUsers values('Mounika','Kasula');
Insert into LibUsers values('Harsha','Reddy');
Insert into LibUsers values('Prince','Arya');
